package com.tamiressr.cursomc.resources.exception;
...
/***
 * classe filtro, trata as exceções
 * 
 * @author tamir
 *
 */
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> validation(MethodArgumentNotValidException e, HttpServletRequest request) {
		...
		//percorre a lista de erros de campos e para cada um gera o obj FieldMessage
